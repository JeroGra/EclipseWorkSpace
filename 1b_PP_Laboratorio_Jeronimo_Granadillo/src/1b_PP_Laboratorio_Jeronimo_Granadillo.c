...
int main(void) {
	...
	eMecanico listaMecanicos[LM]={{1,"Juan",2},{2,"Toti",4},
	    {3,"Pedro",1},{4,"Marquitos",2},{5,"Maria",3},{5,"Melisa",3},{5,"Paco",2},{0,"sin asignar",0}};
	...
	eEspecialidad especialidades[LE]={{1,"Ayudante"},{2,"Tecnico Automotriz"},{3,"Electro mecanica"},{4,"Alineacion y Balanceo"},{0,""}};
