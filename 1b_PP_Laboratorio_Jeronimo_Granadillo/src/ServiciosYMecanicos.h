#ifndef SERVICIOSYMECANICOS_H_
#define SERVICIOSYMECANICOS_H_
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
//Diagnosticos
...
/// @brief machea las FK con las PK correspondientes, es decir compara la FK idMecanico de listaServicios con la PK de Mecanico (id) y asi tambien con Diagnostico
/// y aplica una condicion a cumplir para poder mostrar el Servicio, si se cumple la condicion de que el servicio existe llama a MostrarServicio
/// @param listaServicios
/// @param Mecanico
/// @param sizeM
/// @param Diagnostico
...
/// @brief machea las FK con las PK correspondientes, es decir compara la FK idMecanico de listaServicios con la PK de Mecanico (id) y asi tambien con Diagnostico
/// tambien aplica una condicion para mostrar el servicio, en este caso pregunta que el servicio a mostrar no este diagnosticado, es decir idDiagnostico de listaServicios < 1
/// si se cumple llama a MostrarServicio
/// @param listaServicios
/// @param Mecanico
/// @param sizeM
/// @param Diagnostico
...
/// @brief machea las FK con las PK correspondientes, es decir compara la FK idMecanico de listaServicios con la PK de Mecanico (id) y asi tambien con Diagnostico
/// tambien aplica una condicion para mostrar el servicio, en este caso pregunta que el servicio a mostrar  este diagnosticado, es decir idDiagnostico de listaServicios > 0
/// si se cumple llama a MostrarServicio
/// @param listaServicios
/// @param Mecanico
/// @param sizeM
